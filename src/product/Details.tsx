...
const DetailsScreen: React.FC<Props> = ({product = mock.product}) => {
      ...
      >
       ...
       <Stack  color="blackAlpha.800" marginTop={4} boxSize={60}  marginLeft={2} >
        ...
        <Stack alignItems="center" >
          ...
          <Button colorScheme="blue" variant="link" fontSize={13.5} fontWeight="400" lineHeight="5px" pr="85px">Ver más formas de entrega</Button>
        </Stack>
  ...
  <Tbody>
    <Tr>
      <Td fontWeight="500">Marca</Td>
      <Td>Disney</Td>
      
    </Tr>
    <Tr>
      <Td fontWeight="500">Modelo</Td>
      <Td>Stitch</Td>
      
    </Tr>
    <Tr>
      <Td fontWeight="500">Franquicia</Td>
      <Td>Stitch</Td>
     
    </Tr>
    <Tr>
      <Td fontWeight="500">Animal</Td>
      <Td>Stitch</Td>
    </Tr>
    <Tr>
      <Td fontWeight="500">Personaje</Td>
      <Td>Stitch</Td>
    </Tr>
  </Tbody>
